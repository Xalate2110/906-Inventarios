...
$pdf->setY(92);
$pdf->setX(46);
$pdf->Cell(97,5,utf8_decode("                                                Descripción"),1,1,1,'C');
...
$pdf->Cell(97,5,substr($pro["product"],0,200),'LR',0,'L');
$pdf->Cell(18,5,substr($pro["code"],0,40),'LR',0,'C');
$pdf->Cell(18,5,"$ ".number_format($pro["price"],2,".",","),'LR',0,'R');
$pdf->Cell(21,5,"$ ".number_format($pro["price"]*$pro["qty"],2,".",","),'LR',0,'R');
$pdf->Ln();
$cntxx++;
...
$pdf->setY($ypos_static+10);
$pdf->setX(196);
$pdf->Cell(5,6,"$symbol ".number_format($total_t,2,".",","),0,0,"R");
