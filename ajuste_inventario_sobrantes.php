...
$pdf->Cell(30, 1, "COMPROBANTE ENTRADA DE PRODUCTO ", 0, 4, 'C');
...
$pdf->Cell(260,60,"Informacion General De Entrada  ______________________________________________________________________");
...
$sql_venta="select * from sell where id = $id and operation_type_id = 10 ";
...
$pdf->SetFont('helvetica', '', 10); //Asignar la fuente, el estilo de la fuente (negrita) y el tamaño de la fuente
$pdf->SetXY(10, $y + $yy); //Ubicación según coordenadas X, Y. X=0 porque empezará desde el borde izquierdo de la página
$pdf->Cell(260,75, "ID Entrada Producto : ". $id);

$pdf->SetFont('helvetica', '', 10); //Asignar la fuente, el estilo de la fuente (negrita) y el tamaño de la fuente
$pdf->SetXY(60, $y + $yy); //Ubicación según coordenadas X, Y. X=0 porque empezará desde el borde izquierdo de la página
$pdf->Cell(260,75, "Trabajador : ". $trabajador);

$pdf->SetFont('helvetica', '', 10); //Asignar la fuente, el estilo de la fuente (negrita) y el tamaño de la fuente
$pdf->SetXY(10, $y + $yy); //Ubicación según coordenadas X, Y. X=0 porque empezará desde el borde izquierdo de la página
$pdf->Cell(260,86, "Ref Entrada Productos : ".$referencia_compra);


$pdf->SetFont('helvetica', '', 10); //Asignar la fuente, el estilo de la fuente (negrita) y el tamaño de la fuente
$pdf->SetXY(10, $y + $yy); //Ubicación según coordenadas X, Y. X=0 porque empezará desde el borde izquierdo de la página
$pdf->Cell(260,97, "Fecha Momiento : ".$fecha_compra);
...
$pdf->Cell(260,79, "Usuario : ". $user->name." ".$user->lastname);
...
$pdf->SetFont('helvetica', '', 10); //Asignar la fuente, el estilo de la fuente (negrita) y el tamaño de la fuente
$pdf->SetXY(150, $y + $yy); //Ubicación según coordenadas X, Y. X=0 porque empezará desde el borde izquierdo de la página
$pdf->Cell(260,90, "R - Relacionada : ".$rr);

$pdf->SetFont('helvetica', '', 10); //Asignar la fuente, el estilo de la fuente (negrita) y el tamaño de la fuente
$pdf->SetXY(150, $y + $yy); //Ubicación según coordenadas X, Y. X=0 porque empezará desde el borde izquierdo de la página
$pdf->Cell(260,100, "F - Relacionada : ".$fr);
...
*/
  ...
  $pdf->SetFont('helvetica', 'B', 10); //Asignar la fuente, el estilo de la fuente (negrita) y el tamaño de la fuente
  $pdf->SetXY(10, $y + $yy); //Ubicación según coordenadas X, Y. X=0 porque empezará desde el borde izquierdo de la página
  $pdf->Cell(260,135,"Listado Entrada De Productos  _______________________________________________________________________");
       ...
       operation.sell_id = $id and operation_type_id = 10  ";
        ...
        $pdf->SetXY(25, $y);
        $pdf->MultiCell(25, 4, utf8_decode("ID Producto"), 1, 'C');
        $pdf->SetXY(50, $y);
