...
$pdf->SetY(33); //Mencionamos que el curso en la posición Y empezará a los 12 puntos para escribir el Usuario:
$pdf->SetX(202);
$pdf->Cell(5,$textypos,utf8_decode('Fecha Impresión : ').date('d/m/Y')." | ".date('H:i:s'), 0, 0, 'R');
...
$pdf->Cell(50, -15, "REPORTE DE TRASPASO ", 0, 4, 'C');
...
$pdf->Cell(260,60,utf8_decode("Información General Del Traspaso  _____________________________________________________________________"));


$pdf->SetFont('helvetica', '', 10); //Asignar la fuente, el estilo de la fuente (negrita) y el tamaño de la fuente
$pdf->SetXY(22, 55);
$pdf->Multicell(70,4, "Sucursal Envis : ". utf8_decode($stock_from->name),"C");

$pdf->SetFont('helvetica', '', 10); //Asignar la fuente, el estilo de la fuente (negrita) y el tamaño de la fuente
$pdf->SetXY(120, 55);
$pdf->Multicell(70,4, "Sucursal Recibe : ". utf8_decode($stock_to->name),"C");
...
$usuario = $row[0];}
        ...
        $pdf->SetXY(10, 90 ); //Ubicación según coordenadas X, Y. X=0 porque empezará desde el borde izquierdo de la página
        $pdf->MultiCell(195,4, "".$comentarios, 1, 'J');

        $pdf->SetFont('helvetica', 'B', 10); //Asignar la fuente, el estilo de la fuente (negrita) y el tamaño de la fuente
        $pdf->SetXY(10, $y + $yy); //Ubicación según coordenadas X, Y. X=0 porque empezará desde el borde izquierdo de la página
        $pdf->Cell(260,160,"Listado De Productos En Traspaso ____________________________________________________________________");
