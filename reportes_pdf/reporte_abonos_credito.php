...
$pdf->Cell(50, -43,utf8_decode("HISTORIAL DE ABONOS A CRÉDITO"), 0, 4, 'C');
...
$pdf->SetFont('helvetica', 'B', 10); //Asignar la fuente, el estilo de la fuente (negrita) y el tamaño de la fuente
$pdf->SetXY(87, $y + $yy); //Ubicación según coordenadas X, Y. X=0 porque empezará desde el borde izquierdo de la página
...
$pdf->Cell(260,25,"". $calle);


$pdf->SetFont('helvetica', 'B', 10); //Asignar la fuente, el estilo de la fuente (negrita) y el tamaño de la fuente
$pdf->SetXY(88, $y + $yy); //Ubicación según coordenadas X, Y. X=0 porque empezará desde el borde izquierdo de la página
$pdf->Cell(260,35,"WhatsApp : ". $telefono);
*/
...
$pdf->Cell(260,138, "UUID: ".$folio_factura);
  ...
  $resultado = $mysqli->query($sql);
        ...
        $pdf->SetXY(75, $y);
        $pdf->MultiCell(25, 4, utf8_decode("ID Venta"), 1, 'C');  
        $pdf->SetXY(100, $y);
       ...
       if($row['payment_type_id'] == '2'){
        ...
        $pago2 = "Pago Con Deposito";
        }elseif($row['forma_pago'] == '7'){
        $pago2 = "Pago Con Cheque";
