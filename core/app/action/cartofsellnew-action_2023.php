...
<a data-toggle="modal" data-target="#myModal<?php echo $p["product_id"]?>">
...
<div class="modal fade" id="myModal<?php echo $p["product_id"]?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo $product->code; ?> - <?php echo $product->name; ?></h4>
      </div>
  ...
  <div class="form-group">
    ...
    <input type="text" name="q" id="q<?php echo $p['product_id'];?>" value="<?php echo $p["q"];?>" required class="form-control" id="exampleInputEmail1" placeholder="Cantidad">
  </div>
...
<!-- <div class="col-md-6">
 ...
 <div class="col-md-6">
    ...
    <div class="col-md-2">
      <button type="button" class="btn btn-success" id="click_money"><i class="bi-cash"></i></button>
    </div>
