...
<p class="alert alert-danger">
  Es necesario buscar un producto para realizar una venta.
</p>
<?php endif; ?>
<?php 
//print_r($_SESSION);
...
?>
<tr class="danger">
  <td style="text-align: center"><a href="./?view=editcart"><?php echo $product->code; ?></a></td>
  <td style="text-align: center"><?php echo $product->name; ?></td>
  <td style="text-align: center"><b><?php echo $error["message"]; ?></b></td>
</tr>
...
<div class="form-check">
  <input class="form-check-input" name="p_porcentaje"  type="checkbox" >
  <label class="form-check-label" for="flexCheckDefault">
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Descuento en % (Por Producto)</label>
...
// RELOAD CARTOFSELL
  ...
  echo "class='bg-danger'"; }?><?php echo $p["q"]; ?>><?php echo $qxa; ?></td>
  ...
  <td style="text-align: center"><a id="clearcart-<?php echo $product->id; ?>" class="btn btn-sm btn-danger"><i class="bi-trash"></i></a>
...
<input type="hidden" name="descripcion" value="<?php echo $descripcion; ?>" class="form-control">
  ...
  <input type="hidden" name="descuento_p" value="<?php echo $descuento_p; ?>" class="form-control">
...
<div class="input-group input-group-sm mb-2">
 <textarea name="comment"  placeholder="Comentarios" class="form-control" rows="1"></textarea>
    </div>
  </div>

<div class="col-md-2">
    <label class="control-label">Anticipo a Venta</label>
<div class="input-group input-group-sm mb-1">
<input type="text" name="anticipo_venta" value="0" class="form-control" id="anticipo_venta" placeholder="Anticipo Recibido">
  </div>
</div>
<script>
...
<input type="text"  name="money" value="0" style="font-size: 30px ; text-align: center; color: #ffffff; background:#12a14b; " class="form-control" id="money" placeholder="Efectivo">
</div>
...
if(lim[client]>=cur[client]+(<?php echo $total; ?>-discount)){
          ...
          alert("El cliente no cuenta con crédito autorizado!");
          e.preventDefault();
