...
<div class="card">
  <div class="card-header">Datos de la Venta - Almacen: <b><?php 
...
<button type="button" class="btn btn-secondary btn-block" data-coreui-toggle="modal" data-coreui-target="#myModal">
  <i class="bi bi-person-add"></i>  Cliente
</button>
-->
...
<?php endif; ?>
  ...
  <div class="row">
    ...
    <div class="col-md-2">
      <button type="button" class="btn btn-sm btn-success" id="click_money" data-coreui-toggle="tooltip" data-coreui-placement="bottom" title="Pagar Completo"><i class="bi-cash"></i></button>
    </div>
    <div class="col-md-2">
      <button type="button" class="btn btn-sm btn-success" id="click_0" data-coreui-toggle="tooltip" data-coreui-placement="bottom" title="Pagar Completo">0</button>
    </div>
</div>
  <div class="row">
    ...
    <div class="col-md-3">
      <button type="button" class="btn btn-sm btn-success" id="click_100" data-coreui-toggle="tooltip" data-coreui-placement="bottom" title="Pagar Completo">100</button>
    </div>
    <div class="col-md-3">
      <button type="button" class="btn btn-sm btn-success" id="click_200" data-coreui-toggle="tooltip" data-coreui-placement="bottom" title="Pagar Completo">200</button>
    </div>
    <div class="col-md-3">
      <button type="button" class="btn btn-sm btn-success" id="click_500" data-coreui-toggle="tooltip" data-coreui-placement="bottom" title="Pagar Completo">500</button>
    </div>
    <div class="col-md-3">
      <button type="button" class="btn btn-sm btn-success" id="click_1000" data-coreui-toggle="tooltip" data-coreui-placement="bottom" title="Pagar Completo">1000</button>
    </div>
</div>
<br><br>
...
?>
<tr <?php if($qxa<=$p["q"]){ echo "class='bg-danger'";}else{ echo "class='bg-success'"; }?>>
...
<div class="modal fade" id="myModal<?php echo $p["product_id"]?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <!--<div class="form-group">
    <label for="exampleInputEmail1">Cantidad a Granel (Insertar Monto para calcular la cantidad)</label>
    <input type="text" name="qgranel" id="qgranel<?php echo $p['product_id'];?>" value="0" required class="form-control" id="exampleInputEmail1" placeholder="Cantidad">
  </div>-->
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <select class="form-control" name="price_out" id="price_out<?php echo $p['product_id'];?>">
      <option value="<?php echo $product->price_out; ?>" <?php if($p["price"]==$product->price_out){ echo "selected";}?>> Precio 1: <?php echo $product->price_out; ?></option>
      <option value="<?php echo $product->price_out2; ?>" <?php if($p["price"]==$product->price_out2){ echo "selected";}?>>Precio 2: <?php echo $product->price_out2; ?></option>
      <option value="<?php echo $product->price_out3; ?>" <?php if($p["price"]==$product->price_out3){ echo "selected";}?>>Precio 3: <?php echo $product->price_out3; ?></option>
    </select>
