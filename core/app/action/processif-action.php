...
////////////////////
print "<script>setTimeout(function(){ w = window.open('ajuste_inventario_faltantes.php?id=$s[1]&sucursal=$sell->stock_to_id','ticket','height=720,width=1280');  w.print(); window.location.reload();  }, 100);  </script>";
		}
	}
}
