...
Listado de productos para compra
</div>
...
<div class="form-group">
    ...
    <label for="inputEmail1" class="control-label">Efectivo</label>
      <input type="text" name="money" required class="form-control" id="money" value="<?php echo $total_venta?>" placeholder="Efectivo">
    </div>
  </div>
<br>
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <div class="checkbox">
        <label>
    <a href="index.php?view=clearre" class="btn btn-danger"><i class="bi-trash"></i> Cancelar</a>
...
<script>
  $("#processsell").submit(function(e){
    ...
    if(money<<?php echo $total;?>){
      ...
      go = confirm("¿Seguro Que Deseas ingresar la compra al Sistema?");
      if(go){
      e.preventDefault();
        $.post("./index.php?action=processre",$("#processsell").serialize(),function(data){
          ...
          alert("Compra Realizada Correctamente!, para revisar la compra, ingresa al listado de Compras Realizadas");
        });
      }
