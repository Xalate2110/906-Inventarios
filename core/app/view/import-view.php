...
<button type="button" class="btn btn-outline-dark" data-coreui-toggle="modal" data-coreui-target="#myModal">
  Importar datos
</button>

<button type="button" class="btn btn-outline-dark" data-coreui-toggle="modal" data-coreui-target="#myModal2">
  Instrucciones
</button>
...
<div class="modal fade" id="myModal" tabindex="-1"  aria-hidden="true">
  ...
  <div class="modal-footer">
                    ...
                    <button type="submit"class="btn btn-warning">Generar Proceso</button>
