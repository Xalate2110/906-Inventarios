...
<div class="row">
	<div class="col-md-12">
		<h1><i class='bi-cart4'></i> Compras por Pagar</h1>
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    ...
    <li><a class="dropdown-item" href="report/topay-word.php">Word 2007 (.docx)</a></li>
    <li><a class="dropdown-item" href="report/topay-xlsx.php">Excel 2007 (.xlsx)</a></li>
  <?php endif; ?>
...
<table class="table datatable table-bordered table-hover	">
	...
	<tr>
		<td style="width:30px;"><a href="index.php?view=onere&id=<?php echo $sell->id; ?>" class="btn btn-sm btn-outline-secondary"><i class="bi-eye"></i></a></td>
...
?>			
		...
		<td style="width:120px;">
				<a href="./?action=pay1&id=<?php echo $sell->id; ?>" class="btn btn-sm btn-primary">Pagar</a>
<a href="index.php?view=delre&id=<?php echo $sell->id; ?>" class="btn btn-sm btn-danger"><i class="bi-trash"></i></a></td>
	</tr>
