...
<div class="panel panel-default">
						...
						<h1><i class='glyphicon glyphicon glyphicon-shopping-cart'></i> Listado créditos pagados a proveedor</h1>
						</div>
...
<div class="allfiltercreditosp"></div>


<script type="text/javascript">
	$(document).ready(function(){
		$.get("./?action=filtercreditosp",$("#filtercreditosp").serialize(),function(data){
			$(".allfiltercreditosp").html(data);
		});

		$("#filtercreditosp").submit(function(e){
			e.preventDefault();
		$.get("./?action=filtercreditosp",$("#filtercreditosp").serialize(),function(data){
			$(".allfiltercreditosp").html(data);
		});
