...
$(document).ready(function() {
  ...
  <div class="row">
  <div class="col-md-5"   >
  <h3 style="color: #12C2FF" >Cotizador - Grupo Hules Automotrices</h3> 
  <!--<h3 style="color: #12a14b" >Ticket - <?php echo StockData::getPrincipal()->name;?></h3> -->
</div>
</div>
  <div class="row">
...
<!-- -->
  ...
  <?php $id_almacen =  StockData::getPrincipal()->id; ?>
      <a href ="index.php?view=clients&opt=all&stock=<?php echo $id_almacen; ?>" button type="button" title="Preciona para dar de alta un cliente." class="btn btn-secondary btn-block"><i class="bi bi-person-add"></i></button> </a></div>
  ...
  <button type="button" class="btn btn-dark" title="Preciona para consultar precios de productos" data-coreui-toggle="modal" data-coreui-target="#myModal">Consultar Precios</button></div>     
    ...
    minimumInputLength: 1,
     ...
     $.get("./?action=cartofsellcot",null,function(data5){

      $("#cartofsellcot").html(data5);
      });
    });
...
//      if($("#var_has_credit").val())
    ...
    minimumInputLength: 1,
      ...
      $("#select_product").change(function(){
         $.get("./?action=searchproductcot","product_id="+$(this).val()+"&go=byid",function(data){
...
<script>/*
$(document).ready(function(){
$.get("./?action=cartofsellcot",null,function(data){
  console.log(data)
...
$("#busca_producto").keyup(function(){
  busca = $(this).val();
 if(busca.length>3){
  $.get("./?action=consultapreciocot","producto="+busca,function(data){
