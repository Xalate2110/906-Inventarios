...
<div class="btn-group">
  ...
  <button type="button" class="btn btn-outline-dark dropdown-toggle" data-toggle="dropdown">
    <i class="bi-download"></i> Descargar <span class="caret"></span>
  </button>
...
<span class="box-title">Traspasos</span></div>
<div class="card-body">
...
?>			
	...
	<td> <?php if($sell->user_id!=null){$c= $sell->getUser();echo $c->name." ".$c->lastname;} ?> </td>
		...
		<a  target="_blank" href="ticket-tr.php?id=<?php echo $sell->id; ?>" class="btn btn-sm btn-outline-secondary"><i class='bi-ticket'></i> Ticket</a>

<?php if(isset($_SESSION["user_id"])):?>
<!--
		<a href="index.php?action=cancelsell&id=<?php echo $sell->id; ?>" class="btn btn-sm btn-danger">Cancelar</a> 
		-->
		<a href="index.php?view=deltrasp&id=<?php echo $sell->id; ?>" class="btn btn-sm btn-danger"><i class="bi-trash"></i><a>
<?php endif;?>
		</td>
	</tr>
