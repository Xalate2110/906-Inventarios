...
<script>
    $(document).ready(function () {
     $('#example').DataTable({
            "ajax": 'core/app/json/jfacturasg.php',
            "language": {
            ...
            "aoColumnDefs": [
                {"targets": 6,
                    "render": function (data, type, row) {
                        ...
                        if (row[6] == '3')
                        {
                            return '<span class="fa fa-close" style="color:red;">Cancelado</span>';
                        } else
                        if (row[6] == '')
                        {
                            ...
                            return '<span class="fa fa-check" style="color:green;"> Activa</span>';
                        }
                ...
                {"targets": 7,
                    ...
                    "render": function (data, type, row) {
                        ...
                        if (row[6] != '0') {
                            return "<a id='" + row[4] + "' href='javascript:void()' class='btn btn-danger'   onclick='cancelar(this.id)'>X</a>";
                        } else
                        {
                            return '';
                        }
                    ...
                    "render": function (data, type, row) {
                        ...
                        if (row[6] != '0') {
                            return "<a id='" + row[2] + "' href='javascript:void()' class='btn btn-info'   onclick='enviar_factura(this.id)'><span class='bi-envelope'></span></a>";
                        } else
                        {
                            return '';
                        }
        ...
        if (confirm('¿Seguro que deseas Cancelar La Factura?')) {
            $("#clave2").modal('show');
                    ...
                    if (data == "1" || data == "2") {
                        ...
                        $.ajax({
                            ...
                            success: function (data, textStatus, jqXHR) {
                                ...
                                if (data == true) {
                                    $("#clave2").modal('hide');
                                    alert("SE HA CANCELADO LA FACTURA CORRECTAMENTE, SI LA FACTURA ES DE UN DÍA ANTERIOR, NOTIFICA A CAJA PARA VALIDAR EL CORTE DE CAJA");
...
<div class="panel panel-default">
			...
			<h1><i class='glyphicon glyphicon glyphicon-shopping-cart'></i> Listado General De Facturas</h1>
			</div>
	</div>
...
<div class="card-header">FACTURAS</div>
  ...
  <table id="example" class="table table-bordered table-hover table-responsive" style="width:100%" id = "facturas">
        <thead>
            <tr>
                <th style="text-align: center;width:100px">Nombre Cliente</th>
...
<div class="modal fade" id="enviar_factura" name ="enviar_factura" tabindex="-1"  aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Formulario Cancelación Factura</h5>
      ...
      <div class="form-group">
          ...
          <div class="form-group">
           <label style="padding-top: 20px;">Nombres</label>
            ...
            <input type="text" class="form-control" name="userName" id="userName" value = "Distribuidora Athena - Facturación" />
          </div> 
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="subject" id="subject" value ="Distribuidora Athena - Facturación" />
          </div>
