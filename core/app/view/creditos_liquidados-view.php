...
<div class="panel panel-default">
						...
						<h1><i class='glyphicon glyphicon glyphicon-shopping-cart'></i> Listado General Créditos Liquidados</h1>
						</div>
...
<div class="allfiltercreditos"></div>


<script type="text/javascript">
	$(document).ready(function(){
		$.get("./?action=filtercreditos",$("#filtercreditos").serialize(),function(data){
			$(".allfiltercreditos").html(data);
		});

		$("#filtercreditos").submit(function(e){
			e.preventDefault();
		$.get("./?action=filtercreditos",$("#filtercreditos").serialize(),function(data){
			$(".allfiltercreditos").html(data);
		});
