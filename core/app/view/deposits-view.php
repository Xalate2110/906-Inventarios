...
<div class="btn-group ">
	<a href="index.php?view=newdeposit" class="btn btn-outline-dark"><i class='fa fa-th-list'></i> Nuevo Deposito</a>
</div><br><br>
		<?php
			...
			?>
              <div class="card box-primary">
                <div class="card-header">
                  <span class="box-title">Depositos o Ajustes</span>
                </div><!-- /.box-header -->
<div class="card-body">
			...
			foreach($users as $user){
				...
				<td style="width:130px;"><a href="index.php?view=editdeposit&id=<?php echo $user->id;?>" class="btn btn-warning btn-sm">Editar</a> <a href="index.php?action=deldeposit&id=<?php echo $user->id;?>" class="btn btn-danger btn-sm">Eliminar</a></td>
				</tr>
				<?php
				$total+=$user->price;
