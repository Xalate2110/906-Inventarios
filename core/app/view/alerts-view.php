...
if(isset($_GET["stock"])){ $selstock=$_GET["stock"]; }
  ...
  <a href="index.php?view=alerts&stock=<?php echo $s->id; ?>" class="btn btn-outline-dark"><?php echo $s->name; ?></a>
<?php endforeach; ?>
<?php if($found):?>
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    ...
    <li><a class="dropdown-item" href="report/alerts-xlsx.php?stock=<?php echo $selstock; ?>">Excel (.xlsx)</a></li>
...
<div class="card">
  <div class="card-header">
    <span class="box-title">Alerta de Inventario - <?php echo StockData::getPrincipal()->name; ?></span>
