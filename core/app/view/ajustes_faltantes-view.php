...
<div class="row">
	<div class="col-md-12">
		...
		<h1><i class='glyphicon glyphicon-shopping-cart'></i> Listado General Salidas De Producto</h1>
	  <br>
<form id="filterif">
...
<div class="allfilterif">
</div>


<script type="text/javascript">
  $(document).ready(function(){
    $.get("./?action=filterif",$("#filterif").serialize(),function(data){
      $(".allfilterif").html(data);
    });

    $("#filterif").submit(function(e){
      e.preventDefault();
    $.get("./?action=filterif",$("#filterif").serialize(),function(data){
      $(".allfilterif").html(data);
    });
