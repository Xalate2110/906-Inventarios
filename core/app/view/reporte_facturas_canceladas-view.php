...
<?php else:?>
		<h1><i class='bi-cart4'></i> Reporte Completo De Facturas Canceladas</h1>
...
<form id="filterfacturascanceladas">
<div class="row">
	<div class="col-md-2">
		<label>Almacen</label>
...
<div class="allfilterfacturascanceladas"></div>


<script type="text/javascript">
	$(document).ready(function(){
		$.get("./?action=filterfacturascanceladas",$("#filterfacturascanceladas").serialize(),function(data){
			$(".allfilterfacturascanceladas").html(data);
		});

		$("#filterfacturascanceladas").submit(function(e){
			e.preventDefault();
		$.get("./?action=filterfacturascanceladas",$("#filterfacturascanceladas").serialize(),function(data){
			$(".allfilterfacturascanceladas").html(data);
		});
