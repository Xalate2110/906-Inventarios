...
<div class="panel panel-default">
						...
						<h1><i class='glyphicon glyphicon glyphicon-shopping-cart'></i> Listado General Compras A Crédito</h1>
						</div>
...
<div class="allfilterbyscredit"></div>


<script type="text/javascript">
	$(document).ready(function(){
		$.get("./?action=filterbyscredit",$("#filterbyscredit").serialize(),function(data){
			$(".allfilterbyscredit").html(data);
		});

		$("#filterbyscredit").submit(function(e){
			e.preventDefault();
		$.get("./?action=filterbyscredit",$("#filterbyscredit").serialize(),function(data){
			$(".allfilterbyscredit").html(data);
		});
