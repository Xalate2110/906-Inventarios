...
<div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-7">
<h1>Caja chica</h1>
<a href="./?view=smallbox&opt=new" class="btn btn-secondary">Nueva Operacion</a><br><br>
        </div>
...
<?php if(count($ops)>0):?>
  <div class="card box-primary border-top-dark border-top-3 mb-3" >
  ...
  <td><?php if($op->kind==1){echo "Entrada";}else{ echo "Salida"; }?></td>    
	...
	<td style="width:160px;">
		<a href="./?view=smallbox&opt=edit&id=<?php echo $op->id;?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-pencil"></i> Editar</a>
		<a href="./?action=operations&opt=del&id=<?php echo $op->id;?>&k=1" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i> Eliminar</a>
